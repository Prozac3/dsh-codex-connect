window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		/** Plugin-owned headless device-code login endpoint consumed by its browser half. */
		const OPENAI_CODEX_AUTH_DEVICE_LOGIN_PATH = "/plugins/dsh-openai-codex/auth/device-login";
		...
		function parseDeviceCode(value) {
			...
			if (!isRecord$2(candidate) || typeof candidate["verificationUri"] !== "string" || typeof candidate["userCode"] !== "string" || candidate["userCode"].trim() === "" || candidate["userCode"].length > 256) throw new AccountRequestError("Invalid account response");
			let url;
			try {
				url = new URL(candidate["verificationUri"]);
			} catch {
				throw new AccountRequestError("Invalid account response");
			}
			if (url.protocol !== "https:" || url.username !== "" || url.password !== "" || url.hash !== "") throw new AccountRequestError("Invalid account response");
			const expiresInSeconds = candidate["expiresInSeconds"];
			if (expiresInSeconds !== void 0 && (typeof expiresInSeconds !== "number" || !Number.isFinite(expiresInSeconds) || expiresInSeconds <= 0)) throw new AccountRequestError("Invalid account response");
			return {
			...
			async refresh() {
				...
				try {
					...
					if (!controller.signal.aborted) this.publish({
						...
						...server.status.status === "signing-in" && server.deviceCode !== void 0 ? { deviceCode: server.deviceCode } : {},
			...
			async signIn(method = "browser") {
				...
				try {
					...
					if (method === "browser") {
						...
						if (deviceCode === void 0) throw new AccountRequestError("Invalid account response");
						this.publish({
							status: retained,
							busy: false,
							accounts: this.snapshot.accounts,
		...
		function AccountActions({ t, store, snapshot, compact = false }) {
			...
			const continueLogin = snapshot.deviceCode === void 0 ? "browser" : "device_code";
			if (authorizing) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				style: rowStyle,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					type: "button",
					style: buttonStyle$1,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					disabled: busy,
					onClick: () => {
						store.signIn("device_code");
					},
					children: t("deviceCodeLogin")
				})]
			});
		}
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								status.status === "reauth-required" && !authorizing ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AccountActions, {
									t,
									store,
									snapshot,
									compact: true
		...
		function AccountFeedback({ t, snapshot, store }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				deviceCode === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: {
						display: "flex",
						flexDirection: "column",
						gap: 8,
					...
					children: [
						...
						deviceCode.expiresInSeconds === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							style: bodyStyle,
							children: t("deviceCodeExpiry", { minutes: Math.ceil(deviceCode.expiresInSeconds / 60) })
						})
					]
				}),
				loginUrl !== void 0 || snapshot.operation.kind === "waiting-authorization" && !snapshot.busy && deviceCode === void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: {
						display: "flex",
						flexWrap: "wrap",
						alignItems: "center",
					...
					children: [loginUrl === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("a", {
						...
						children: t("openLoginInBrowser")
					}), snapshot.operation.kind === "waiting-authorization" && !snapshot.busy && deviceCode === void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ManualCallbackForm, {
						t,
						store
		...
		*/
		...
		const en = {
			...
			deviceCodeLogin: "Use device code",
			deviceCodeHelp: "Open the verification page on any device, sign in, and enter this one-time code. The DSH server will finish authorization automatically.",
			deviceCodeExpiry: "This code expires in {minutes} minutes.",
			logout: "Sign out",
			working: "Working…",
			retry: "Retry",
		...
		const zh = {
			...
			login: "使用 ChatGPT 登录",
			loginAgain: "重新登录",
			deviceCodeLogin: "使用设备码登录",
			deviceCodeHelp: "在任意设备打开验证页面，登录后输入这组一次性设备码。DSH 服务器会自动完成授权。",
			deviceCodeExpiry: "此设备码将在 {minutes} 分钟后过期。",
			logout: "退出登录",
			working: "处理中…",
			retry: "重试",
